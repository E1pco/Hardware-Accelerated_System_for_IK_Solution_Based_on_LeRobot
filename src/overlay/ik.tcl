...
#
# ik.tcl: Tcl script for re-creating project 'axi_uartlite_loopback'
#
# Generated by Vivado on Sat Dec 20 06:15:41 CST 2025
...
#
# 1. This project restoration tcl script (ik.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/elpco/code/PYNQ-Z2/axi_uartlite_loopback/axi_uartlite_loopback.srcs/constrs_1/new/test.xdc"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/code/PYNQ-Z2/axi_uartlite_loopback/axi_uartlite_loopback.srcs/constrs_1/new/test.xdc"]"\
  ]
  foreach ifile $files {
  ...
  set paths [list \
 "[file normalize "$origin_dir/[file normalize "$origin_dir/code/lerobot/ik_hls/ik_solver/xf_solver_cholesky/hls/impl"]"]"\
  ]
  foreach ipath $paths {
...
set _xil_proj_name_ "axi_uartlite_loopback"
...
set orig_proj_dir "[file normalize "$origin_dir/code/PYNQ-Z2/axi_uartlite_loopback"]"
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/code/lerobot/ik_hls/ik_solver/xf_solver_cholesky/hls/impl"]" $obj
...
set file "[file normalize "$origin_dir/code/PYNQ-Z2/axi_uartlite_loopback/axi_uartlite_loopback.srcs/constrs_1/new/test.xdc"]"
...
set_property -name "target_constrs_file" -value "[get_files [list "*new/test.xdc"]]" -objects $obj
set_property -name "target_part" -value "xc7z020clg400-1" -objects $obj
set_property -name "target_ucf" -value "[get_files [list "*new/test.xdc"]]" -objects $obj
...
\
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"1.16428",
   "Default View_TopLeft":"283,-470",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.8.0 2024-04-26 e1825d835c VDI=44 GEI=38 GUI=JA:21.0 TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 3 -x 2290 -y -180 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 3 -x 2290 -y 30 -defaultsOSRD
preplace port uart2 -pg 1 -lvl 3 -x 2290 -y 200 -defaultsOSRD
preplace port port-id_uart_rx -pg 1 -lvl 3 -x 2290 -y 490 -defaultsOSRD -right
preplace port port-id_uart_tx -pg 1 -lvl 3 -x 2290 -y 520 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 1 -x 580 -y 190 -defaultsOSRD
preplace inst rst_ps7_0_100M -pg 1 -lvl 1 -x 580 -y -290 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 2 -x 1340 -y -300 -defaultsOSRD
preplace inst axi_uart16550_0 -pg 1 -lvl 2 -x 1340 -y 490 -defaultsOSRD
preplace inst axi_uartlite_2 -pg 1 -lvl 2 -x 1340 -y 340 -defaultsOSRD
preplace inst xf_solver_lm_so101_0 -pg 1 -lvl 2 -x 1340 -y -100 -defaultsOSRD
preplace inst xf_solver_lm_so101_1 -pg 1 -lvl 2 -x 1340 -y 40 -defaultsOSRD
preplace netloc axi_uart16550_0_sout 1 2 1 1540 500n
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 400 -390 1120 -450 1550
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 3 410 -460 N -460 1560
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 0 2 410 530 1090
preplace netloc rst_ps7_0_100M_peripheral_reset 1 1 1 N -290
preplace netloc uart3_tx_1 1 2 1 1580 480n
preplace netloc axi_uartlite_2_UART 1 2 1 1540 200n
preplace netloc processing_system7_0_DDR 1 2 1 1580 -350n
preplace netloc processing_system7_0_FIXED_IO 1 2 1 1570 -330n
preplace netloc processing_system7_0_M_AXI_GP0 1 0 3 390 -440 N -440 1540
preplace netloc ps7_0_axi_periph_M00_AXI 1 1 1 1100 -120n
preplace netloc ps7_0_axi_periph_M01_AXI 1 1 1 1130 20n
preplace netloc ps7_0_axi_periph_M02_AXI 1 1 1 750 -340n
preplace netloc ps7_0_axi_periph_M03_AXI 1 1 1 1110 -320n
preplace netloc ps7_0_axi_periph_M04_AXI 1 1 1 1140 -300n
preplace netloc ps7_0_axi_periph_M06_AXI 1 1 1 1100J 230n
preplace netloc ps7_0_axi_periph_M07_AXI 1 1 1 750 250n
levelinfo -pg 1 -590 580 1340 2290
pagesize -pg 1 -db -bbox -sgen -630 -910 2410 860
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse [list design_1.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/code/PYNQ-Z2/axi_uartlite_loopback/axi_uartlite_loopback.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
