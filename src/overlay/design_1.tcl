...
xilinx.com:hls:xf_solver_lm_so101:1.0\
"
...
\
  ...
  # Create instance: xf_solver_lm_so101_0, and set properties
  set xf_solver_lm_so101_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:xf_solver_lm_so101:1.0 xf_solver_lm_so101_0 ]

  # Create instance: xf_solver_lm_so101_1, and set properties
  set xf_solver_lm_so101_1 [ create_bd_cell -type ip -vlnv xilinx.com:hls:xf_solver_lm_so101:1.0 xf_solver_lm_so101_1 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins ps7_0_axi_periph/M00_AXI] [get_bd_intf_pins xf_solver_lm_so101_0/s_axi_control]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins ps7_0_axi_periph/M01_AXI] [get_bd_intf_pins xf_solver_lm_so101_1/s_axi_control]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins ps7_0_axi_periph/M02_AXI] [get_bd_intf_pins processing_system7_0/S_AXI_GP0]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M03_AXI [get_bd_intf_pins ps7_0_axi_periph/M03_AXI] [get_bd_intf_pins processing_system7_0/S_AXI_HP0]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M04_AXI [get_bd_intf_pins ps7_0_axi_periph/M04_AXI] [get_bd_intf_pins processing_system7_0/S_AXI_HP1]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M06_AXI [get_bd_intf_pins ps7_0_axi_periph/M06_AXI] [get_bd_intf_pins axi_uartlite_2/S_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M07_AXI [get_bd_intf_pins ps7_0_axi_periph/M07_AXI] [get_bd_intf_pins axi_uart16550_0/S_AXI]
  ...
  [get_bd_pins ps7_0_axi_periph/S02_ACLK] \
  ...
  [get_bd_pins xf_solver_lm_so101_0/ap_clk] \
  [get_bd_pins xf_solver_lm_so101_1/ap_clk]
  ...
  [get_bd_pins ps7_0_axi_periph/S02_ARESETN] \
  ...
  [get_bd_pins ps7_0_axi_periph/M08_ARESETN] \
  [get_bd_pins axi_uartlite_2/s_axi_aresetn] \
  [get_bd_pins xf_solver_lm_so101_0/ap_rst_n] \
  [get_bd_pins xf_solver_lm_so101_1/ap_rst_n]
  connect_bd_net -net rst_ps7_0_100M_peripheral_reset  [get_bd_pins rst_ps7_0_100M/peripheral_reset]
  connect_bd_net -net uart3_tx_1  [get_bd_ports uart_rx] \
  [get_bd_pins axi_uart16550_0/sin]

  # Create address segments
  assign_bd_address -offset 0x44A00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_uart16550_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x40020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_uartlite_2/S_AXI/Reg] -force
  assign_bd_address -offset 0x60000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs processing_system7_0/S_AXI_GP0/GP0_M_AXI_GP0] -force
  assign_bd_address -offset 0x40000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs xf_solver_lm_so101_0/s_axi_control/Reg] -force
  assign_bd_address -offset 0x40010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs xf_solver_lm_so101_1/s_axi_control/Reg] -force
